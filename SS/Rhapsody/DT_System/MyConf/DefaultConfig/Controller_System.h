...
//!	Generated Date	: Sun, 8, Aug 2021  
	File Path	: MyConf\DefaultConfig\Controller_System.h
*********************************************************************/
...
#ifdef _OMINSTRUMENT
    friend class OMAnimatedController_System;
#endif // _OMINSTRUMENT

    ////    Constructors and destructors    ////
    
    //## auto_generated
    Controller_System(void);
...
#ifdef _OMINSTRUMENT
//#[ ignore
class OMAnimatedController_System : virtual public AOMInstance {
    DECLARE_META(Controller_System, OMAnimatedController_System)
